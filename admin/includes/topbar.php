    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item text-center small text-gray-500" href="#">全部提醒</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow mx-1">
            <a class="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                ...
                <!-- Counter - Messages -->
				<?php
				$select_count = "select count(*) as count from contact";
            ...
            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
				...
				while ($row_contact = mysqli_fetch_array($run_contact)) {
					...
					echo "
                        ...
                        <a class='dropdown-item d-flex align-items-center' href='show.php'>
				...
				?>
                <a class="dropdown-item text-center small text-gray-500" href="#">查阅更多信息</a>
            </div>
        </li>
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
               aria-haspopup="true" aria-expanded="false">
                <span class="mr-2 d-none d-lg-inline text-gray-600 small">Tokyo</span>
